        ...
        return Observable_1.Observable.of(null).mergeMap(function () {
            ...
            if (request.url.endsWith('/api/authenticate') && request.method === 'POST') {
                ...
                var filteredUsers = users.filter(function (user) {
                    return user.card === request.body.card && user.pin === request.body.pin;
                });
                if (filteredUsers.length) {
                    ...
                    return Observable_1.Observable.throw('Card No. or PIN is incorrect');
                }
            }
            // get users
            ...
            if (request.url.endsWith('/api/users') && request.method === 'POST') {
                ...
                // validation
                var duplicateUser = users.filter(function (user) { return user.card === newUser_1.card; }).length;
                if (duplicateUser) {
                    return Observable_1.Observable.throw('Card No. "' + newUser_1.card + '" is already taken');
                }
                // save new user
